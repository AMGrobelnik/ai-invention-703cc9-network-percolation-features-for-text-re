...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/messages/1_create_idea/round_1/1_gen_hypo.md` — 181 messages
    - `chat/messages/1_create_idea/round_1/2_review_hypo.md` — 34 messages
- **2. test_idea** — `invention_loop`
  - round_1
    - `chat/messages/2_test_idea/round_1/1_gen_strat.md` — 11 messages
    - `2_gen_plan/` — 3 task(s)
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_dataset_1.md` — 118 messages
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 39 messages
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 21 messages
    - `3_gen_art/` — 3 task(s)
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 379 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 369 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_research_1.md` — 145 messages
    - `chat/messages/2_test_idea/round_1/4_gen_paper_text.md` — 94 messages
  ...
  - round_2
    ...
    - `3_gen_art/` — 1 task(s)
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 178 messages
    - `chat/messages/2_test_idea/round_2/4_gen_paper_text.md` — 122 messages
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 3 task(s)
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_1.md` — 98 messages
  ...
  - `2_gen_demo_art/` — 3 task(s)
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_dataset_1.md` — 98 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 174 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_experiment_2.md` — 198 messages
  - `chat/messages/3_report_results/3_gen_full_paper.md` — 189 messages
